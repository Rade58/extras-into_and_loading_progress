...
// We are going to use LoadingManager; just see how we used it
// insid our code

// since we are using loading manager, make sure to remove
// other callbacks from loaders, since loading manger callbacks will
// be used for awaiting all the assets

// inside onLoad we can define hiding of overlay we have
// inside onProgress we can define animation of loading bar

// we will use gsap library to animate overlay

// we can move loaders and loader manger code bellow
// overlay material since we are going to deal with overlay
// inside onLoad callback of the loading manager
